...
[![Travis-CI Build Status](https://travis-ci.org/benmarwick/ArchaeoGLOBE.svg?branch=master)](https://travis-ci.org/benmarwick/ArchaeoGLOBE)  [![Binder](http://mybinder.org/badge.svg)](http://beta.mybinder.org/v2/gh/benmarwick/ArchaeoGLOBE/master?urlpath=rstudio)
