...
# don't get the restricted files
...
rerun_time_consuming_analysis <- FALSE # FALSE for do not run the modelling code
...
if(rerun_time_consuming_analysis) {
  ...
  trend_dat <- readRDS('data/derived-data/trend_dat.rda')
  writeLines(paste0('trend_dat downloded from https://osf.io/kcr2e/ on ', Sys.Date()), con = 'data/derived-data/README.md', sep = '')
  message("Done.")
  } 
}
```
...
# and upload to osf.io
osf_retrieve_file("kcr2e") %>% osf_upload("data/derived-data/trend_dat.rda", overwrite = TRUE)
