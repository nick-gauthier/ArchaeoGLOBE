...
ArchaeoGLOBE_Public_Data_DOI <- 'doi:10.7910/DVN/CNCANQ'
ArchaeoGLOBE_Public_Data_df <- get_dataset(ArchaeoGLOBE_Public_Data_DOI)
...
```{r dataverse-shapefile, echo=T, eval = F}
...
regions <- st_read('../Simplified_Regions2/Simplified_Regions2.shp')
```
