...
onset_maps <- onsets %>%
  ...
  scale_fill_viridis_d(name = 'Onset timestep', na.value = 'lightgray',
                       labels = c('8000BP', '6000BP', '4000BP', '3000BP', '2000BP',
                                  '1000BP', '1500CE', '1750CE', '1850CE', '2000CE', 'None')) +
...
```{r results='hide', fig.width = 6.5, fig.height = 7.5}
