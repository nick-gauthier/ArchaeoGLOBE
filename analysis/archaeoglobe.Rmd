...
get_g_data <- function(row_n){
  
  trend_dat[row_n,]$mod[[1]] %>%
...
# this is a problem on circle-ci
gdata_3 <- get_g_data(3)
...
g1data_fn_enquo <- get_g_data1("HUNT")

```

```{r, echo = FALSE, eval = T}
g1data_fn_orig <- get_g_data(3)
```

```{r, echo = FALSE}
g1 <- ggplot(g1data_fn_orig,
