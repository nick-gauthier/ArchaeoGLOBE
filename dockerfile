...
RUN . /etc/environment \
  ...
  && sudo apt-get update \
  && sudo apt-get install libudunits2-dev libgdal-dev gdal-bin libproj-dev proj-data proj-bin libgeos-dev xvfb  mesa-common-dev libglu1-mesa-dev freeglut3-dev  -y \
